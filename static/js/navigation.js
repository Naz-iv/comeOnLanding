...
const n = (l = {
        ...
        c)
    ,
    o = ["a[href]", 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', "select:not([disabled]):not([aria-hidden])", "textarea:not([disabled]):not([aria-hidden])", "button:not([disabled]):not([aria-hidden])", "[contenteditable]", '[tabindex]:not([tabindex^="-"])'];
var l, c;
document.addEventListener("click", (() => {
    }
));
const {state: s, actions: a} = (0,
    n.store)("js/navigation", {
    state: {
        get roleAttribute() {
            return "overlay" === (0,
                n.getContext)().type && s.isMenuOpen ? "dialog" : null
        },
        get ariaModal() {
            return "overlay" === (0,
                n.getContext)().type && s.isMenuOpen ? "true" : null
        },
        get ariaLabel() {
            const e = (0,
                n.getContext)();
            return "overlay" === e.type && s.isMenuOpen ? e.ariaLabel : null
        },
        get isMenuOpen() {
            return Object.values(s.menuOpenedBy).filter(Boolean).length > 0
        },
        get menuOpenedBy() {
            const e = (0,
                n.getContext)();
            return "overlay" === e.type ? e.overlayOpenedBy : e.submenuOpenedBy
        }
    },
    actions: {
        openMenuOnHover() {
            const {type: e, overlayOpenedBy: t} = (0,
                n.getContext)();
            "submenu" === e && 0 === Object.values(t || {}).filter(Boolean).length && a.openMenu("hover")
        },
        closeMenuOnHover() {
            a.closeMenu("hover")
        },
        ...
        toggleMenuOnClick() {
            const e = (0,
                ...
                , {ref: t} = (0,
                n.getElement)();
            window.document.activeElement !== t && t.focus();
            const {menuOpenedBy: o} = s;
            o.click || o.focus ? (a.closeMenu("click"),
                a.closeMenu("focus")) : (e.previousFocus = t,
                a.openMenu("click"))
        },
        handleMenuKeydown(e) {
            const {type: t, firstFocusableElement: o, lastFocusableElement: l} = (0,
                n.getContext)();
            if (s.menuOpenedBy.click) {
                if ("Escape" === e?.key)
                    return a.closeMenu("click"),
                        void a.closeMenu("focus");
                "overlay" === t && "Tab" === e.key && (e.shiftKey && window.document.activeElement === o ? (e.preventDefault(),
                    l.focus()) : e.shiftKey || window.document.activeElement !== l || (e.preventDefault(),
                    o.focus()))
            }
        },
        handleMenuFocusout(e) {
            const {modal: t} = (0,
                n.getContext)();
            (null === e.relatedTarget || !t?.contains(e.relatedTarget) && e.target !== window.document.activeElement) && (a.closeMenu("click"),
                a.closeMenu("focus"))
        },
        openMenu(e = "click") {
            const {type: t} = (0,
                n.getContext)();
            s.menuOpenedBy[e] = !0,
            "overlay" === t && document.documentElement.classList.add("has-modal-open")
        },
        closeMenu(e = "click") {
            const t = (0,
                n.getContext)();
            s.menuOpenedBy[e] = !1,
            s.isMenuOpen || (t.modal?.contains(window.document.activeElement) && t.previousFocus?.focus(),
                t.modal = null,
                t.previousFocus = null,
            "overlay" === t.type && document.documentElement.classList.remove("has-modal-open"))
        }
    },
    callbacks: {
        initMenu() {
        ...
        initNav() {
            ...
            function o(t) {
                e.isCollapsed = t.matches
            }

            return e.isCollapsed = t.matches,
